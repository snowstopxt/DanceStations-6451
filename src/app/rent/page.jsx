    ...
    const myGeocode = (address) => {
      ...
      const handleSubmit = async () => {
        try {
            ...
            const geocode = myGeocode(location);
            const geohash = geofire.geohashForLocation([geocode.lat, geocode.lng]);
            console.log('geocode', geocode);
            console.log('geohash', geohash);
            await createStudio({name, mrt, geohash, geocode, size, price, description, image});
              ...
              <form>
                ...
                <FormControl id="studioImage">
                  ...
                  <FormControl id="studioName">
                    ...
                    <Input type="text" placeholder="Enter studio name" value={name}
                        onChange={(e) => setName(e.target.value)}/>
                  </FormControl>
                  <FormControl id="location">
                    <FormLabel>Location</FormLabel>
                    <Input type="text" placeholder="Enter studio location" value={location}
                        onChange={(e) => setLocation(e.target.value)}/>
                  </FormControl>
                  <FormControl id="mrt">
                    <FormLabel>Nearest Mrt</FormLabel>
                    <Input type="text" placeholder="Enter mrt station" value={mrt}
                        onChange={(e) => setMrt(e.target.value)}/>
                  </FormControl>
                  <FormControl id="size">
                    <FormLabel>Studio size (square meters)</FormLabel>
                    <Input type="text" placeholder="Enter studio size" value={size}
                        onChange={(e) => handleNumericInput(e, setSize)}/>
                  </FormControl>
                  <FormControl id="price">
                    <FormLabel>Price per Hour</FormLabel>
                    <Input type="number" placeholder="Enter price per hour" value={price}
